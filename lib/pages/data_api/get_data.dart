...
class GetData {
  ...
  String url = 'https://vrmapi.victronenergy.com/v2/installations/'; // url first part
  String precision; // precision of what i want. here i want stats from installation: '/stats'
  String start; // where we want to start getting info (timestamp)
  String end; // where we want to end. 0 = now (timestamp)
